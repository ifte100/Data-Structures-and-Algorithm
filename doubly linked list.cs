...
namespace DoublyLinkedList
{
    public class DoublyLinkedList<T>
    {
        ...
        // Read the instruction carefully, study the code examples from above as they should help you to write the rest o returnf the code.
        ...
        public INode<T> AddBefore(INode<T> before, T value)
        {
            ...
            Node<T> next = before as Node<T>;
            return AddBetween(value, previous, next);
        ...
        //reassigning previous and next pointers after removing a node. not required in the task but eliminating repetitive code
        public void pointerReassign(INode<T> node)
        {
        ...
        {
            if (Head.Next == null && Tail.Previous == null) throw new InvalidOperationException("The list is empty.");

            Node<T> current_node = Head.Next;
            pointerReassign(current_node);
            Count--;
